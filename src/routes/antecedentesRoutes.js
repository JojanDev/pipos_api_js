...
router.get("/mascota/:id", AntecedenteController.getAllAntecedentesByMascotaId);

// Obtener un tipo de documento por ID
router.get("/:id", AntecedenteController.getAntecedenteById);

// Crear un nuevo tipo de documento
router.post("/", validarAntecedente, AntecedenteController.createAntecedente);

// Actualizar un tipo de documento
router.put("/:id", validarAntecedente, AntecedenteController.updateAntecedente);
