...
export const campos = [
  ...
  { name: "id_cliente", required: false, minLength: 1, maxLength: 11, type: "number" }, // puede ser NULL
  { name: "id_personal", required: false, minLength: 1, maxLength: 11, type: "number" }, // puede ser NULL
