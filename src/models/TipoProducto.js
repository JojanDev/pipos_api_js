...
class TipoProducto extends Modelo {
   ...
   * @param {Object} tipoProducto - Objeto con los datos del tipo de documento {nombre}
   ...
   * @param {Object} tipoProducto - Objeto con los nuevos datos del tipo de documento
