...
class InfoMedicamento extends Modelo {
  ...
  async getAll() {
    try {
      ...
      throw new Error(
        `Error al obtener toda la informacion de medicamentos: ${error.message}`
      );
    }
  }
  ...
  async getById(id) {
    try {
      ...
      throw new Error(
        `Error al obtener la informacion de medicamento con ID ${id}: ${error.message}`
      );
    }
  }
   ...
   * @param {Object} infoMedicamento - Objeto con los datos del tipo de documento {nombre}
  ...
  async create(infoMedicamento) {
    try {
      ...
      throw new Error(
        `Error al crear la informacion de medicamento: ${error.message}`
      );
    }
  }
   ...
   * @param {Object} infoMedicamento - Objeto con los nuevos datos del tipo de documento
  ...
  async update(id, infoMedicamento) {
    try {
      ...
      throw new Error(
        `Error al actualizar la informacion del medicamento con ID ${id}: ${error.message}`
      );
    }
  }
  ...
  async delete(id) {
    try {
      ...
      throw new Error(
        `Error al eliminar la informacion de medicamento con ID ${id}: ${error.message}`
      );
    }
  }
}
