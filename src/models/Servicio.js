...
class Servicio extends Modelo {
  ...
  async getAll() {
    try {
      ...
      throw new Error(
        `Error al obtener todas los servicios: ${error.message}`
      );
    }
  }
   ...
   * @param {Object} servicio - Objeto con los datos del tipo de documento {nombre}
   ...
   * @param {Object} servicio - Objeto con los nuevos datos del tipo de documento
