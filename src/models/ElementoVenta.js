...
class ElementoVenta extends Modelo {
  #tableName = "elementos_ventas";
  ...
  async getAll() {
    try {
      ...
      throw new Error(
        `Error al obtener todas los elementos de ventas: ${error.message}`
      );
    }
  }
  ...
  async getById(id) {
    try {
      ...
      throw new Error(
        `Error al obtener el elemento de venta con ID ${id}: ${error.message}`
      );
    }
  }
   ...
   * @param {Object} elementoVenta - Objeto con los datos del tipo de documento {nombre}
   * @returns {Promise<Object|null>} El tipo de documento creado con su ID, o null si falló
   * @throws {Error} Si ocurre un error en la inserción
   */
  async create(elementoVenta) {
    try {
      const idCreado = await super.create(this.#tableName, elementoVenta);
      if (idCreado) {
        return await this.getById(idCreado);
      }
      return null;
    } catch (error) {
      throw new Error(`Error al crear el elemento de venta: ${error.message}`);
    }
  }
   ...
   * @param {Object} elementoVenta - Objeto con los nuevos datos del tipo de documento
   * @returns {Promise<Object|null>} El tipo de documento actualizado, o null si falló
   * @throws {Error} Si ocurre un error en la actualización
   */
  async update(id, elementoVenta) {
    try {
      if (await super.update(this.#tableName, id, elementoVenta)) {
        return await this.getById(id);
      }
      return null;
    } catch (error) {
      throw new Error(
        `Error al actualizar el elemento de venta con ID ${id}: ${error.message}`
      );
    }
  }
  ...
  async delete(id) {
    try {
      ...
      throw new Error(
        `Error al eliminar el elemento de venta con ID ${id}: ${error.message}`
      );
    }
  }
}
